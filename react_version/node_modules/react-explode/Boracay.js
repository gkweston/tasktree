...
function Boracay(_ref) {
  ...
  var linesRefs = (0, _react.useRef)(_toConsumableArray(Array(COUNT)).map(function () {
  ...
  var center = size / 2;
  var strokeWidth = Math.ceil(size * STROKE_WIDTH / 100);
  ...
  }, [prevSize, prevRepeat, prevDelay, prevRepeatDelay, onComplete, onStart, onRepeat]);
  ...
  }, /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, linesRefs.current.map(function (ref, i) {
