...
var _Shape = _interopRequireDefault(require("./Icons/Shape"));
...
var DEGREE = 360;
var RATIO = 25;
var SHAPE_WIDTH = 82.5;
var SHAPE_HEIGHT = 7.5;
var CIRCLE_SIZE = 13;
var ORIGINS = [[400, 50], [400, 100], [-300, 50]];
var TIME_LINE = null;
...
function Cebu(_ref) {
  ...
  var strokeWidth = Math.ceil(prevSize * 0.5 / 100);
  var animateBubbles = (0, _react.useCallback)(function () {
    ...
    for (var i = 0; i < CIRCLES.length; i++) {
      ...
      timeline.fromTo(circle, 1.5, {
        ...
        rotation: 120,
        scale: 1,
        transformOrigin: "".concat(origin[0], "% ").concat(origin[1], "%"),
        ease: ease
      });
  ...
  var animateShape = (0, _react.useCallback)(function () {
    var ease = _gsap.Power4.easeOut;
    var timelines = [];

    for (var i = 0; i < SHAPES.length; i++) {
      var shape = SHAPES[i];
      var degree = i % 2 == 0 ? DEGREE + RATIO : -(DEGREE - RATIO);
  ...
  }, [prevDelay, prevSize, prevRepeat, prevRepeatDelay, onStart, onComplete, onRepeat, animateShape, animateBubbles]);
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    return /*#__PURE__*/_react["default"].createElement(_react.Fragment, {
      key: i
    }, /*#__PURE__*/_react["default"].createElement(_Shape["default"], {
      ...
      style: {
        ...
        transformOrigin: "45% 50%",
        position: "absolute",
        width: "".concat(SHAPE_WIDTH, "%"),
        height: "".concat(SHAPE_HEIGHT, "%")
      }
    }), i <= 2 && /*#__PURE__*/_react["default"].createElement(_Circle["default"], {
      ref: function ref(el) {
        return CIRCLES[i] = el;
      },
      stroke: color,
